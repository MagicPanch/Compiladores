...
clausula_seleccion_if:	IF condicion cuerpo_if END_IF ','                                               {System.out.print("(CLAUSULA DE SELECCION IF SIN POSIBLES RETORNOS Y SIN ELSE) "); $$.nodo = generador_codigo_intermedio.generarNodo("IF", $2.nodo, generador_codigo_intermedio.generarNodoUnidireccional("CUERPO_IF", generador_codigo_intermedio.generarNodoUnidireccional("THEN", $3.nodo)));}
...
clausula_seleccion_if_de_return_parcial:    IF condicion cuerpo_if_retorno_parcial END_IF ','                                                               {System.out.print("(CLAUSULA DE SELECCION IF DE RETORNO PARCIAL Y SIN ELSE) "); $$.nodo = generador_codigo_intermedio.generarNodo("IF", $2.nodo, generador_codigo_intermedio.generarNodoUnidireccional("CUERPO_IF", generador_codigo_intermedio.generarNodoUnidireccional("THEN", $3.nodo)));}
                                            ...
                                            | IF condicion cuerpo_if_retorno_completo END_IF ','                                                            {System.out.print("(CLAUSULA DE SELECCION IF DE RETORNO COMPLETO Y SIN ELSE) "); $$.nodo = generador_codigo_intermedio.generarNodo("IF", $2.nodo, generador_codigo_intermedio.generarNodoUnidireccional("CUERPO_IF", generador_codigo_intermedio.generarNodoUnidireccional("THEN", $3.nodo)));}
...
public static void main (String [] args) {
    if (args.length == 1) {
            ...
            System.out.print(" [257] -> IF");
            System.out.print(" [258] -> ELSE");
            System.out.print(" [259] -> END_IF");
            System.out.print(" [260] -> PRINT");
            System.out.print(" [261] -> CLASS");
            System.out.print(" [262] -> VOID");
            System.out.print(" [263] -> INT");
            System.out.print(" [264] -> ULONG");
            System.out.print(" [265] -> DOUBLE");
            System.out.println();
            System.out.print("[266] -> FOR");
            System.out.print(" [267] -> IN");
            System.out.print(" [268] -> RANGE");
            System.out.print(" [269] -> IMPL");
            System.out.print(" [270] -> INTERFACE");
            System.out.print(" [271] -> IMPLEMENT");
            System.out.print(" [272] -> RETURN");
            System.out.print(" [273] -> CONSTANTE DOUBLE");
            System.out.println();
            System.out.print("[274] -> CONSTANTE INT");
            System.out.print(" [275] -> CONSTANTE ULONG");
            System.out.print(" [276] -> CADENA MULTILINEA");
            System.out.print(" [277] -> ID");
